...
class IMG_Stegno:
    ...
    def main(self, root):
        ...
        encode = Button(frame, text="Encode", command=lambda: self.encode_frame1(frame),
                        padx=14, bg='#e3f4f1')
    ...
    def encode_frame2(self, e_F2):
        ...
        if not myfile:
            ...
            global a
            a = self.password_store(myfile)  # Generate hash for image file
    ...
    def password_store(self, file_path):
    ...
    def password_return(self):
        password1 = simpledialog.askstring(title="Password", prompt="enter the password")
        return password1
    ...
    def enc_fun(self, text_a, myImg):
        ...
        if (len(data) == 0):
            ...
            newImg.save(
                filedialog.asksaveasfilename(initialfile=temp, filetypes=([('png', '*.png')]), defaultextension=".png"))
